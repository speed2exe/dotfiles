...
bind '"\C-H":"source ~/.config/bash/fzf_rev_dir_history\n"'
bind '"\C-T":"source ~/.config/bash/fd_goto\n"'
bind '"\C-A":"source ~/.config/bash/fzf_rev_git_history\n"'
bind '"\C-G":"source ~/.config/bash/goto_git_root\n"'
