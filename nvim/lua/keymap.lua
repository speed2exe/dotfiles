...
set('n', '<leader>b', ':enew<CR>:redir => m | silent buffers | redir END | put=m<CR>ggdj:set buftype=nofile<CR>:%normal dt"di"viwpldtldt r:<CR>:g/^\\[/d<CR>:g/:\\/\\//d<CR>:set syntax=rust<CR>gg')
set('n', '<leader>j', ':enew<CR>:redir => m | silent jumps | redir END | put=m<CR>ddggd2j:set buftype=nofile<CR>:g/:\\/\\//d<CR>:%normal wwhyt $pF r:0veeelx<CR>:g/^:/d<CR>:set syntax=rust<CR>gg')
