...
" let g:nvim_tree_ignore = [] "empty by default "moved to setup
...
let g:nvim_tree_special_files = { 'README.md': 1, 'Makefile': 1} " List of filenames that gets highlighted with NvimTreeSpecialFile
